...
public class WsBTOrdenTranferenciaTINDto {
	...
	public WsBTOrdenTranferenciaTINDto(String debtorParticipantCode, String creditorParticipantCode,
			...
			String grossSalaryAmount, String salaryPaymentIndicator, String monthOfThePayment, String yearOfThePayment,
			String branchId, String settlementDate, String instructionId, String interbankSettlementAmount) {
		super();
