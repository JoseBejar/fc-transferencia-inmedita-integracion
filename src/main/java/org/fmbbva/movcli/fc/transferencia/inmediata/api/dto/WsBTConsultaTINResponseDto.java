...
public class WsBTConsultaTINResponseDto {
	...
	public WsBTConsultaTINResponseDto(String debtorParticipantCode, String creditorParticipantCode, String creationDate,
			...
			String creditorCreditCard, String sameCustomerFlag, String currency, String proxyType) {
		super();
		this.debtorParticipantCode = debtorParticipantCode;
		this.creditorParticipantCode = creditorParticipantCode;
		this.creationDate = creationDate;
